        ...
        <Layout>
          ...
          <Content style={{ margin: '16px' }}>
            <Routes>
              ...
              <PrivateRoute path="/rol" element={<Rol />} />
              <PrivateRoute path="/formatohistoriaclinica" element={<FormatoHistoriaClinica />} />
              <PrivateRoute path="/paciente" element={<Paciente />} />
              <PrivateRoute path="/informacionpersonal" element={<InformacionPersonal />} />
              <PrivateRoute path="/usuario" element={<Usuario />} />
            </Routes>
          </Content>
        </Layout>
      </Layout>
